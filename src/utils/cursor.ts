...
class Cursor {
  ...
  init() {
    ...
    document.onmouseenter = _e => this.cursor.classList.remove('hidden')
    document.onmouseleave = _e => this.cursor.classList.add('hidden')
    document.onmousedown = _e => this.cursor.classList.add('active')
    document.onmouseup = _e => this.cursor.classList.remove('active')
  }
...
function cursorInit(con: HTMLElement) {
